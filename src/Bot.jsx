...
//     const [counter, setCounter] = useState(0);
    ...
    return (
        ...
        //             {
        //                 counter === 0
        //                     ? <button className="btn btn-incrementer" onClick={() => setCounter(counter + 1)}>ADD</button>
        //                         : <button className="btn btn-decrementer" onClick={() => setCounter(counter - 1)}>REMOVE</button>
        //             }
        //         </div>
        //     </div>
